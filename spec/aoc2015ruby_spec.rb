...
describe Aoc2015ruby do
  ...
  it 'Day04: First hash with prefix "00000" is 254575'    do expect(Day04.solve('00000')).to eq(254575) end # 4b ttl
  ...
  it 'Day06: There are 543903 lights on'        do expect(Day06.solve1).to eq(543903) end            # 6a+b both ttl
  ...
  it 'Day10: The length after 50 iterations is 6989950' do expect(Day10.solve2).to eq(6989950) end    # 10b ttl
  ...
  it 'Day15: The highest cookie score is 18965440'                      do expect(Day15.solve1).to eq(18965440) end #ttl
  it 'Day15: The highest score for the 500 calorie cookie is 15862900'  do expect(Day15.solve2).to eq(15862900) end #ttl
